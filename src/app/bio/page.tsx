...
export default function BioPage() {
  ...
  return (
    <div className={styles.wrapper}>
      <title>Bằng Lái Xanh - Bio Link</title>
      ...
      <div className={styles.container} ref={cardRef} id="glassCard">
        ...
        <div className={styles.linkGrid}>
          ...
          <a href="tel:0362225161" className={styles.glassBtn}>
            <svg style={{ color: '#ef4444' }} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M20.01 15.38C18.81 15.38 17.66 15.19 16.56 14.83C16.22 14.71 15.83 14.8 15.57 15.06L13.43 17.2C10.68 15.8 8.19 13.31 6.8 10.57L8.94 8.43C9.2 8.16 9.28 7.78 9.17 7.44C8.81 6.34 8.62 5.19 8.62 4C8.62 3.45 8.17 3 7.62 3H4.19C3.65 3 3 3.24 3 4.1C3 14.1 11.23 22 21 22C21.72 22 22 21.43 22 20.81V17.38C22 16.83 21.55 16.38 21 16.38H20.01V15.38Z" /></svg>
            <span>036.222.5161</span>
          </a>

          {/* TikTok */}
          <a href="https://www.tiktok.com/@banglaixanh" target="_blank" className={styles.glassBtn}>
            <svg style={{ color: '#000000' }} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" /></svg>
            <span>TikTok</span>
          ...
          <a href="https://www.facebook.com/share/1BsHBFWZRK/?mibextid=wwXIfr" target="_blank" className={styles.glassBtn}>
            <svg style={{ color: '#1877F2' }} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2.04C6.5 2.04 2 6.53 2 12.06C2 17.06 5.66 21.21 10.44 21.96V14.96H7.9V12.06H10.44V9.85C10.44 7.34 11.93 5.96 14.22 5.96C15.31 5.96 16.45 6.15 16.45 6.15V8.62H15.19C13.95 8.62 13.56 9.39 13.56 10.18V12.06H16.34L15.89 14.96H13.56V21.96A10 10 0 0 0 22 12.06C22 6.53 17.5 2.04 12 2.04Z" /></svg>
            <span>Fanpage</span>
            <svg className={styles.iconArrow} viewBox="0 0 24 24"><path d="M8.59 16.59L13.17 12L8.59 7.41L10 6L16 12L10 18L8.59 16.59Z" /></svg>
          </a>
          ...
          <a href="https://www.facebook.com/groups/825155033605894" target="_blank" className={styles.glassBtn}>
            <svg style={{ color: '#1877F2' }} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M16 11C16 12.51 14.92 13.75 13.5 13.96C13.82 14.6 14 15.28 14 16V18H20V16C20 14.28 17.06 13.25 15.5 13.04C15.81 12.44 16 11.74 16 11ZM12.5 12C14.43 12 16 10.43 16 8.5C16 6.57 14.43 5 12.5 5C10.57 5 9 6.57 9 8.5C9 10.43 10.57 12 12.5 12ZM7.06 13.25C5.5 13.46 2.5 14.5 2.5 16.25V18H11.5V16.25C11.5 14.5 8.56 13.46 7.06 13.25ZM7 12C8.66 12 10 10.66 10 9C10 7.34 8.66 6 7 6C5.34 6 4 7.34 4 9C4 10.66 5.34 12 7 12Z" /></svg>
            <span>Hỏi Đáp Tình Huống Giao Thông</span>
            <svg className={styles.iconArrow} viewBox="0 0 24 24"><path d="M8.59 16.59L13.17 12L8.59 7.41L10 6L16 12L10 18L8.59 16.59Z" /></svg>
          </a>
