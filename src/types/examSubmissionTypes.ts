...
export type ExamSubmissionAnswerDto = components['schemas']['ExamSubmissionAnswerDto']
export type SubmitQuestionDto = components['schemas']['SubmitQuestionDto']
export type SubmitAnswerDto = components['schemas']['SubmitAnswerDto']
