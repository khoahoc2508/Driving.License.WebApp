...
// Base Response Types
export type BaseResponseOfStatisticOverview = components['schemas']['BaseResponseOfGetStatisticOverviewByTimeRangeResponse']
export type BaseResponseOfExamPassFailPercentage = components['schemas']['BaseResponseOfGetExamPassFailPercentageByTimeRangeResponse']
export type BaseResponseOfVehicleTypePercentage = components['schemas']['BaseResponseOfGetVehicleTypePercentageByTimeRangeResponse']
export type BaseResponseOfVehicleTypeQuantity = components['schemas']['BaseResponseOfGetVehicleTypeQuantityByTimeRangeResponse']
...
export type DataFollowExamScheduleResponse3 = components['schemas']['DataFollowExamScheduleResponse3']
