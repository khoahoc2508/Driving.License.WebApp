...
export type SetExamScheduleForLicenseRegistrationCommandType =
  components['schemas']['SetExamScheduleForLicenseRegistrationCommand']
export type RemoveExamScheduleForLicenseRegistrationCommandType =
  components['schemas']['RemoveExamScheduleForLicenseRegistrationCommand']
export type SetExamScheduleForBulkLicenseRegistrationsCommandType =
  components['schemas']['SetExamScheduleForBulkLicenseRegistrationsCommand']

// API Request Types for Exam Schedule Results
