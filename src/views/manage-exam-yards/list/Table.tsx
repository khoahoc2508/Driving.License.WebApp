...
import type { GetExamYardsDto, ExamYardListType } from '@/types/examYardTypes'
import CustomPagination from '@/components/common/CustomPagination'
import { useScrollbarHover } from '@/hooks/useCustomScrollbar'

// Column Definitions
const columnHelper = createColumnHelper<GetExamYardsDto>()
...
const Table = ({
    ...
    data?: ExamYardListType,
    setData: (data: ExamYardListType) => void,
    pageNumber: number,
    pageSize: number,
    totalItems: number,
    ...
    isLoading: boolean,
    onEditExamYard?: (examYard: GetExamYardsDto) => void
}) => {
    // States
    ...
    // Hooks
    const columns = useMemo<ColumnDef<GetExamYardsDto, any>[]>(
        () => [
            ...
            columnHelper.accessor('id', {
                ...
                cell: ({ row }) => (
                    <div className="flex items-center justify-center">
                        <IconButton disabled={!row.original.createdBy} onClick={() => onEditExamYard?.(row.original)}>
    ...
    const handleDeleteConfirmed = async () => {
        ...
        try {
            const response = await examYardsAPI.DeleteExamYard(itemIdToDelete);
            ...
            >
                ...
                <DialogContent>
                    <Typography id="alert-dialog-description">
                        Bạn có chắc chắn muốn xóa sân thi này không?
                    </Typography>
                </DialogContent>
                <DialogActions>
