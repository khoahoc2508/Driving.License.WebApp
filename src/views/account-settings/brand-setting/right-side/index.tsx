                ...
                <CardContent>
                    <div style={{ marginBottom: 16 }}>
                        <TextField
                            ...
                            multiline
                            minRows={2}
                            value={`${process.env.NEXT_PUBLIC_APP_URL}/dang-ky-bang-lai-xe-may?ownerid=${data?.user?.id}`}
                    ...
                    <div>
                        <TextField
                            ...
                            multiline
                            minRows={2}
                            value={`${process.env.NEXT_PUBLIC_APP_URL}/dang-ky-bang-lai-o-to?ownerid=${data?.user?.id}`}
                            InputProps={{ readOnly: true }}
                            sx={{ mb: 3, '& .MuiInputBase-input': { whiteSpace: 'pre-line' } }}
                        />
                    </div>
