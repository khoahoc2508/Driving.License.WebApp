...
const Table = ({
    ...
    data?: DATDeviceListType,
    setData: (data: DATDeviceListType) => void,
    pageNumber: number,
    pageSize: number,
    totalItems: number,
    ...
    isLoading: boolean,
    onEditDATDevice?: (datDevice: GetDATDevicesDto) => void
}) => {
    // States
    ...
    // Hooks
    const columns = useMemo<ColumnDef<GetDATDevicesDto, any>[]>(
        () => [
    ...
    return (
        <>
            ...
            <DeleteConfirmationDialog
                ...
                title="Bạn chắc chắn xóa thiết bị DAT này?"
                itemName={data.find(item => item.id === itemIdToDelete)?.name}
                itemType="thiết bị DAT"
