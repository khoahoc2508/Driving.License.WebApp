...
import type { DATDeviceListType, GetDATDevicesQueryParams, GetDATDevicesDto } from '@/types/datDeviceTypes'
import datDevicesAPI from '@/libs/api/datDevicesAPI'
import DebouncedInput from '@/components/common/DebouncedInput'
import AddDATDeviceDialog, { DialogMode } from './AddDATDeviceDialog'
...
const ManageDATDevicesList = () => {
    ...
    const [params, setParams] = useState<GetDATDevicesQueryParams>()

    // Modal states
    const [openAddDialog, setOpenAddDialog] = useState(false)
    const [editData, setEditData] = useState<GetDATDevicesDto | null>(null)
    ...
    const getDATDevices = async (params: GetDATDevicesQueryParams): Promise<void> => {
        try {
            setLoading(true)
            const res = await datDevicesAPI.GetDATDevices(params)
...
export default ManageDATDevicesList
