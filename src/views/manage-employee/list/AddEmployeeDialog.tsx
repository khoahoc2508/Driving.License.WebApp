...
const AddEmployeeDialog = ({
    ...
    useEffect(() => {
        if (editData && mode === DialogMode.EDIT) {
            ...
            setValue('assigneeType', editData.assigneeType || CONFIG.AssigneeTypes.Employee as AssigneeType)
        }
    ...
    const onSubmit = async (data: FormData) => {
        ...
        try {
            ...
            if (response.data.success) {
                const successMessage = mode === DialogMode.EDIT ? 'Chỉnh sửa nhân viên thành công' : 'Thêm nhân viên thành công'
                toast.success(successMessage)
                handleClose()
                onSuccess()
            } else {
                const errorMessage = mode === DialogMode.EDIT ? 'Có lỗi xảy ra khi chỉnh sửa nhân viên' : 'Có lỗi xảy ra khi thêm nhân viên'
    ...
    const getDialogTitle = () => {
        return mode === DialogMode.EDIT ? 'Chỉnh sửa nhân viên' : 'Thêm nhân viên'
    }
