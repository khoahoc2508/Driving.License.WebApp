...
const Table = ({
    ...
    isLoading: boolean,
    onEditEmployee?: (employee: AssigneeDto) => void
}) => {
    // States
            ...
            columnHelper.accessor('id', {
                ...
                cell: ({ row }) => (
                    <div className="flex items-center justify-center">
                        <IconButton disabled={!row.original.createdBy} onClick={() => onEditEmployee?.(row.original)}>
    ...
    return (
        <>
            ...
            <DeleteConfirmationDialog
                ...
                itemName={data.find(item => item.id === itemIdToDelete)?.fullName}
                itemType="nhân viên"
