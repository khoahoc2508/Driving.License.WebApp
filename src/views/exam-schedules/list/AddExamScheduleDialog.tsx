...
const AddExamScheduleDialog = (props: Props) => {
  // Props
    ...
    <>
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)}>
          <DialogTitle id='alert-dialog-slide-title'>{isEditMode ? 'Chỉnh sửa lịch thi' : 'Tạo lịch thi'}</DialogTitle>
          <DialogContent>
...
export default AddExamScheduleDialog
