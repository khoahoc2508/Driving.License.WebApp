...
import LicenseRegistrationTable from "@/views/exam-schedules/list/update-result-license-registrations/list/LicenseRegistrationTable"
...
const ResultLicenseRegistrationsDrawer = (props: Props) => {
  // Props
  ...
  return (
    <>
      <Drawer
        ...
        sx={{ '& .MuiDrawer-paper': { width: { xs: "90%", sm: "40%" } } }}
      >
...
export default ResultLicenseRegistrationsDrawer 
